...
import { ContactUsPage } from './pages/cContactUsPage'
import { LoginPage } from './pages/lLoginPage'
import { ProductDetailsPage } from './pages/pProductDetailsPage'
import { ProductsPage } from './pages/pProductsPage'
...
import { CheckoutPage } from './pages/cCheckoutPage'
import { PaymentPage } from './pages/pPaymentPage'
import { OrderConfirmationPage } from './pages/oOrderConfirmationPage'
